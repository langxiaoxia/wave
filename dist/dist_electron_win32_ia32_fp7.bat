...
del %out_dir%\electron-v13.1.4-win32-ia32.zip
ren %out_dir%\dist.zip electron-v13.1.4-win32-ia32.zip

cd %root_dir%\src
del %out_dir%\pdb.zip
call python electron\script\zip-symbols.py -b %out_dir%
del %out_dir%\electron-v13.1.4-win32-ia32-pdb.zip
ren %out_dir%\pdb.zip electron-v13.1.4-win32-ia32-pdb.zip
