...
function getScreenCapture() {
  console.info('getDisplayMedia start!');
  closeStream()
  let constraints = {
    audio: false,
    video: {
  ...
  console.warn("getDisplayMedia constraint:\n" + JSON.stringify(constraints, null, '  '));
  navigator.mediaDevices.getDisplayMedia(constraints).then(function (stream) {
    console.warn('getDisplayMedia success:', stream.id);
    connectButton.disabled = false;
    localStream = stream;
    localVideo.srcObject = stream;
    videoType = 'slides'
    ...
    console.error(e)
    console.warn('getDisplayMedia error:' + e.name);
  });
}
